...
export function UsdtIcon({className, invert, size}: {className?: string, invert?: boolean, size?: number}) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width={size || 16} height={size || 16} viewBox="0 0 32 32">
      <g fill="none" fillRule="evenodd">
        <circle cx="16" cy="16" r="16" fill={invert ? "#F89007" : "#191B1F"}/>
        <path fill={invert ? "#191B1F" : "#F89007"}
